...
import 'package:flutter_application_2/Prayer/PrayerReaponde.dart';

List<Map<String, dynamic>> data = [
  {
    "Azkir": {
      "Azkir": "   أَسْـتَغْفِرُ الله، أَسْـتَغْفِرُ الله، أَسْـتَغْفِرُ الله.",
      "Repetition": 1
    }
  },
  {
  ...
  {
    "Azkir": {
      "Azkir": "سُـبْحانَ اللهِ، والحَمْـدُ لله ، واللهُ أكْـبَر",
      "Repetition": 33
    }
  },
  {
  ...
  {
    "Azkir": {"Azkir": "اللَّهُمَّ أَجِرْنِي مِنْ النَّار. ", "Repetition": 7}
  },
  {
    "Azkir": {
      "Azkir":
...
List<PrayerAzkarReapond> PrayerList =
    data.map((e) => PrayerAzkarReapond.fromjson(e)).toList();
